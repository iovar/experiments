module.exports = function(grunt) {
  grunt.initConfig({
    ...
    watch: {
      ...
      assets: {
        files: ['audio/**','img/**','icon.png','fonts/**','res/**'],
    ...
    clean: {
      assets: ['build/img/**','build/audio/**','build/fonts/**','build/res/**'],
      build: ['build/**']
    },
    copy: {
      assets: {
  ...
  grunt.registerTask('default', ['clean:build','copy','includes','coffee','uglify','cssmin','replace']);
